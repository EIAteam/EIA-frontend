...
<el-row class="panel-group" :gutter="40">
    <el-col :xs="12" :sm="12" :lg="4" class="card-panel-col" v-for="company in companyList" :key="company.id">
      <div class='card-panel' @click="handleredirect(company.companyId,company.position)" shadow="always">
        <div class="card-panel-icon-wrapper icon-people">
          <svg-icon icon-class="peoples" class-name="card-panel-icon" fill:="#67C23A"/>
        </div>
