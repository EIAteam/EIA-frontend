  ...
  methods: {
    getBasicFormInfo() {
      getFormInfo(this.projectId).then(response => {
        ...
        this.basicInfoForm.EAcompanyName = response.projectInfo.EAcompanyName
        ...
        this.basicInfoForm.EAcompanyCertificatenumber = response.projectInfo.EAcompanyCertificatenumber
        this.basicInfoForm.EAcompanyTelephone = response.projectInfo.EAcompanyTelephone
        this.basicInfoForm.EAcompanyAddress = response.projectInfo.EAcompanyAddress
