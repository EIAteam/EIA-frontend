<template>
    <el-form :model="geographicInfoForm" label-width="100px;" ref="geographicInfoForm" :rules="formRules" labelPosition="top">
    ...
    <el-row>
      ...
      <el-form-item label="声环境质量标准" prop="soundEnvironmentStandard">
        <el-select v-model="geographicInfoForm.soundEnvironmentStandard" placeholder="请选择" style="width:400px;">
    ...
    <el-row>
      ...
      <el-form-item label="生活污水去向" prop="domesticSewageGo">
        <el-input v-model="geographicInfoForm.domesticSewageGo" type="text" style="width:400px;" :disabled="true"></el-input>
      </el-form-item>
      </el-col>
    </el-row>
      ...
      <el-form-item label="生活污水排放标准" prop="domesticSewageEmissionStandards">
        <el-input v-model="geographicInfoForm.domesticSewageEmissionStandards" type="textarea"  style="width:700px;" :disabled="true"></el-input>
      </el-form-item>

    <el-row>
      <el-col :span="12">
      <el-form-item label="敏感点距离" prop="sensitivePointDistance">
        <el-select v-model="geographicInfoForm.sensitivePointDistance" placeholder="请选择" style="width:400px;">
      ...
      <el-form-item label="水源保护区距离" prop="waterSourceDistance">
        <el-select v-model="geographicInfoForm.waterSourceDistance" placeholder="请选择" style="width:400px;">
...
export default {
  ...
  methods: {
    getGroundwaterInformation: function($event) {
